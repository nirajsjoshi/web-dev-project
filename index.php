...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">Connect</h1>
      <p class="lead fw-normal">Connect with everyone during this pandemic.Now you can freely chat with ur friends using our free platform</p>
      <form action="claim.php" method="post">
        connect.com/<input type="text" name="room">
